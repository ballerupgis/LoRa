...
# APPLICATION
#Test
driver.get("https://iotnet.teracom.dk/application/<dit_applikatioons_id>")
...
class sendIotKeys(object):
    ...
    try:
        ...
        def enrollment(self):
           ...
           driver.get("https://iotnet.teracom.dk/application/BE7A11F0/enrolldevice")
           time.sleep(1)
...
time.sleep(1)
driver.get("https://iotnet.teracom.dk/application/<dit_applications_id>/devices")
print('Done')
